...
set half_duration_triangle = `cat half_duration.out`  # TODO : It shall be better to send this to the script with an option. Ex : ./convolve_source_timefunction fileToConvolve --hdur 11.2
